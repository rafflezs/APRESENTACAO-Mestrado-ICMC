...
Aqui estão as fronteiras dos métodos que **garantem factibilidade** — o exato e as duas MIP-heurísticas, Relax-and-Fix e Híbrido. [aponte] Nos 15 dias, os três ficam praticamente colados na fronteira ótima do exato. Já nos 60 e 90 dias, note uma sutileza importante: como o exato **não convergiu**, a fronteira dele já é sub-ótima — e por isso alguns pontos das heurísticas parecem passar por cima dela. [pausa] Um ponto que faço questão de deixar claro: o **NSGA-II não aparece aqui**. Ele viola a cobertura mínima, então plotá-lo nesta mesma fronteira seria comparar coisas não comparáveis — eu mostro os resultados dele em separado, mais adiante nesta seção. [transição]
